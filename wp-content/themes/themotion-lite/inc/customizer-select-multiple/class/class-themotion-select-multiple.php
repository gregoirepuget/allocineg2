 ...
 * @access public
 */
class Themotion_Select_Multiple extends WP_Customize_Control {
	/**
	...
	public $custom_class = '';
	/**
	 * Themotion_Select_Multiple constructor.
	 *
	...
	public function enqueue() {
		wp_enqueue_script( 'themotion-customizer-select-multiple', get_template_directory_uri() . '/inc/customizer-select-multiple/js/script-themotion-select-multiple.js', array( 'jquery', 'customize-base' ), THEMOTION_VERSION, true );
	}
	/**
